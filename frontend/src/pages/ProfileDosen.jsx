    ...
    <main className="flex-grow max-w-4xl mx-auto w-full p-4 sm:p-6 lg:p-8 space-y-6 mt-4">
      <div className="bg-[#0f1626] rounded-xl p-6 md:p-10 border border-gray-800 shadow-xl">
        <div className="flex items-center justify-between mb-8 border-b border-gray-800 pb-4">
          <h2 className="text-2xl font-bold text-yellow-400">Profil Dosen</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 flex flex-col items-center text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-400">{profile?.nip || profile?.username}</p>
              <span className="inline-block mt-2 px-4 py-1 bg-blue-500/20 text-blue-400 rounded-full text-xs font-bold border border-blue-500/30">
            ...
            <div className="bg-[#1e2638] rounded-xl p-6 border border-gray-700 shadow-md">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex justify-between border-b border-gray-700 pb-3">
                  ...
                  <span className="text-white font-medium">{profile?.nip || '-'}</span>
                </div>
